...
srun ketos test -d cuda:0 -f alto -m nfd_best.mlmodel -e split/test.txt > test_fine-tuning_générale.txt

# The script can be executed with the following command:
# sbatch NAME.sh
# test 1 : 1 hours
#it's work, but use always this kind of path for the "model" and the test.txt, otherwise it fails.